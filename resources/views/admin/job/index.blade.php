        ...
        <div class="card-body">
            ...
            <div class="table-responsive">
                <table class="table table-striped" id="dataTable" class="display">
                    ...
                    <tbody>
                        @foreach (App\Models\Job::get() as $key => $item)
                            <tr>
                                <td>{{ ++$key }}</td>
                                <td>{{ $item->title }}</td>
                                <td>{{ $item->company }}</td>
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary jobEditBtn" data-id="{{ $item->id }}"><i class="far fa-edit"></i></button>
                                    <button type="button" class="btn btn-danger jobDelete" data-id="{{ $item->id }}">X</button>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
